...
@Mod(modid = "StevesWorkshop", name = StevesProduction.NAME, version = "0.3.0")
public class StevesProduction {
    ...
    //TODO furnaces?
    //TODO move nei stuff
    //TODO From the NEI API: "This is the main class that handles item property configuration. WARNING: DO NOT access this class until the world has been loaded These methods should be called from INEIConfig implementors"
    @SideOnly(Side.CLIENT)
    private void fixNeiQuestionMarks() {
